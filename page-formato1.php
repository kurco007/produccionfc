                        ...
                        <div class="sabores">
                            <div class="cantidad">
                                <p> <?php the_field('cajeta_coyotas'); ?> y
                                    <?php the_field('charolas_cajeta_coyotas'); ?> Cajeta</p>
                                <p> <?php the_field('jamoncillo'); ?> y
                                    <?php the_field('charolas_jamoncillo_coyotas'); ?> Jamoncillo</p>
                                <p> <?php the_field('piloncillo'); ?> y
                                    <?php the_field('charolas_piloncillo_coyotas'); ?> Piloncillo</p>
                                <p> <?php the_field('nuez'); ?> y <?php the_field('charolas_nuez_coyotas'); ?> Nuez</p>
